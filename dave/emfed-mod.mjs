...
let n=new Date(e.created_at).toLocaleString(),a=e.media_attachments.filter(s=>s.type==="image"),gifvs=e.media_attachments.filter(s=>s.type==="gifv"),videos=e.media_attachments.filter(s=>s.type==="video");
